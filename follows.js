(function ( $ ){
	...
	*/
	...
	var defaultKey		= '', // Unique master Xively API key to be used as a default
		...
		applicationName	= 'Kamida Technology Inc', // Replaces Xively logo in the header
		dataDuration	= '90day'// Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '04B404', // CSS HEX value of color to represent data (omit leading #)
